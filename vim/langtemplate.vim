...
function! SetupClangTidy()
    ...
    call append(0, [ "Checks: '-*,clang-diagnostic-*,llvm-*,misc-*,-misc-unused-parameters,-misc-non-private-member-variables-in-classes,-misc-no-recursion,readability-identifier-naming,clang-diagnostic-*,clang-analyzer-*,cppcoreguidelines-*,modernize-*,-modernize-use-trailing-return-type'",
                \"AnalyzeTemporaryDtors: false",
                \"FormatStyle:     google",
            \"#lower_case UPPER_CASE camelBack CamelCase camel_Snake_Back Camel_Sanke_Case aNy_CasE Leading_upper_snake_case",
            \"CheckOptions:",
